...
FT240_init:
    ldaa    #$FC
    staa    PIA_ACR         ; Disable input latching, don't touch the other bits
    ...
    oraa    #FT240_WRMSK    ; WR is ouptut
    anda    #$3F            ; TXE# and RXF# are input
    staa    PIA_DDRB
    rts
...
PutChar:
    ...
    bita    #$40
    bne     PutChar         ; When set the FIFO is full, keep polling until there is room
